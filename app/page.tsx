...
export default function Page() {
  return <main>
    <nav className="nav"><a className="monogram" href="#top" aria-label="Bosh sahifa">S<span>&</span>U</a><div className="nav-links"><a href="#story">Biz haqimizda</a><a href="#details">Tadbir tafsilotlari</a><a href="#rsvp">Javob berish</a></div><a className="nav-date" href="#details">{data.dateLabel}</a></nav>
    <section className="hero" id="top"><div className="hero-copy"><p className="eyebrow">Taklifnoma</p><h1>Sodirbek <i>&</i><br />Umidaxon</h1><p className="hero-note">Bizning muhabbatimizga guvoh bo‘lishga<br />sizni chin dildan taklif qilamiz.</p><a className="scroll-link" href="#story"><span className="scroll-line" />Pastga aylantiring</a></div><div className="hero-image"><Image src={data.heroImage} alt="Sodirbek va Umidaxon to‘y libosida" fill priority sizes="(max-width: 768px) 100vw, 52vw" /></div><div className="hero-vertical">08 NOYABR · 2026</div></section>
    ...
    <section className="rsvp section" id="rsvp"><div className="section-label">05 / Javobingiz</div><div className="rsvp-grid"><div><p className="display-title">Sizning<br /><em>ishtirokingiz</em><br />biz uchun muhim.</p><p className="body-copy">Iltimos, 1-noyabrgacha javobingizni yuboring.</p></div><RSVP /></div></section>
    <footer><div className="footer-mark">S <span>&</span> U</div><p>Sevgi bilan, Sodirbek va Umidaxon</p><a href="#top">Yuqoriga ↑</a></footer>
    <div className="dev-credit"><a href="https://kebyu.uz" target="_blank" rel="noreferrer"><Image src="/images/kebyu-logo.png" alt="Kebyu" width={60} height={60} /><span>Kebyu tomonidan ishlab chiqilgan</span></a></div>
  </main>
}
